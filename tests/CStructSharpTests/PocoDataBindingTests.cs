...
public class PocoDataBindingTests
{
    ...
    /// <summary>
    ///     Regression coverage for the architecture improvement plan's optimization that caches member resolution per (type, name) instead of re-running reflection on every call.
