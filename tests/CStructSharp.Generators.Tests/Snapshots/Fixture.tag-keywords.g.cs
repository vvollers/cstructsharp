...
namespace Demo
{
    ...
    public static partial class FixtureTagKeywords
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 1 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        /// <param name="source">The bytes of the records, with nothing else after them.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // child value
            {
                ...
                EncodeChild(ref cursor, value.Value, variables, "value", "child");
                placement.CompleteField(cursor.Position);
            }
            cursor.Seek(placement.Current, member, memberType);
            cursor.Pad((int)(placement.Finish(1) - placement.Current), member, memberType);
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureTagKeywords.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureTagKeywords.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureTagKeywords.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureTagKeywords.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureTagKeywords.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary>The members of <c>Value</c>.</summary>
            public static class Value
            {
                /// <summary><c>offsetof(root, value.value)</c>.</summary>
                public const int ValueMember = 0;
            }
        }
        ...
        public static class Update
        {
            ...
            public static class Value
            {
                /// <summary>Stores <c>value.value</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void ValueMember(global::System.Span<byte> target, byte value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.value.value");
                    try
                    {
                        cursor.Position = 0;
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>A view of <c>child value</c> at offset 0.</summary>
            public ChildView Value => new(this.source.Slice(0), this.options);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 1 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <see cref="ToObject"/> uses; <see langword="null"/> uses the documented defaults.</param>
            /// <returns>The enumeration.</returns>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 1 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                if (this.source.Length - next < 1)
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 1, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
