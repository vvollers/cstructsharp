// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureConditionalFields. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureConditionalFields
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "struct root { uint8 tag; if(tag == 1) { uint24< number; } else { utf8 label[3]; } uint8 tail; };";
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            if (placementArm0 != 1 && value.HasNumber)
            {
                throw cursor.Fail("Inactive conditional field supplied: number", member, memberType);
            }
            if (placementArm0 == 1)
            {
                if (!value.HasNumber)
                ...
                cursor.Seek(placement.AdvanceToField(1), "number", "uint24<");
                {
                    ...
                    try
                    {
                        global::CStructSharp.Generated.Codec.WriteUInt24(encoded, value.Number, true);
                    }
                    catch (global::CStructSharp.Diagnostics.CStructWriteException exception)
                    {
                        throw cursor.WithMember(exception, "number", "uint24<");
                    }
                    encoded.CopyTo(cursor.Reserve(3, "number", "uint24<"));
                }
                placement.CompleteField(cursor.Position);
            }
            // utf8 label[3]
            if (placementArm0 != 0 && value.HasLabel)
            {
                throw cursor.Fail("Inactive conditional field supplied: label", member, memberType);
            }
            if (placementArm0 == 0)
            {
                if (!value.HasLabel)
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureConditionalFields.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureConditionalFields.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureConditionalFields.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureConditionalFields.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureConditionalFields.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary><c>offsetof(root, tag)</c>.</summary>
        ...
        {
            /// <summary>Stores <c>tag</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Tag(global::System.Span<byte> target, byte value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.tag");
                try
                {
                    cursor.Position = 0;
                    cursor.Reserve(1, "tag", "uint8")[0] = value;
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint8 tag</c> at offset 0.</summary>
            public byte Tag => this.source.Slice(0, 1)[0];
