...
namespace Demo
{
    ...
    public static partial class Types
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>inner</c> after another until the memory ends - on the enumeration step that reaches each; each record is 1 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].inner</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        public static global::System.Collections.Generic.IEnumerable<Inner> RecordsInner(global::System.ReadOnlyMemory<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromMemory(source, Sizes.Inner, "inner", options, InnerRecordReader(variables));

        /// <summary>Reads the records of a sequence of segments (one segment in place, several through one pooled copy that lives as long as the enumeration); see <see cref="RecordsInner(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The bytes of the records, with nothing else after them.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<Inner> RecordsInner(global::System.Buffers.ReadOnlySequence<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromSequence(source, Sizes.Inner, "inner", options, InnerRecordReader(variables));

        /// <summary>Reads the records of a stream from its current position: exactly one record at a time, byte-exact, from any readable stream; a seekable stream sits at the record's end after each step. See <see cref="RecordsInner(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="stream">The stream, read from its current position.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<Inner> RecordsInner(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead)
            {
        ...
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IAsyncEnumerable<Inner> RecordsInnerAsync(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead)
            {
            ...
            return global::CStructSharp.Generated.RecordSequence.FromStreamAsync(stream, Sizes.Inner, "inner", options, InnerRecordReader(variables), cancellationToken);
        }

        /// <inheritdoc cref="RecordsInner(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Inner> Records(global::System.ReadOnlyMemory<byte> source, global::CStructSharp.ReadOptions? options = null) => RecordsInner(source, null, options);

        /// <inheritdoc cref="RecordsInner(global::System.Buffers.ReadOnlySequence{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Inner> Records(global::System.Buffers.ReadOnlySequence<byte> source, global::CStructSharp.ReadOptions? options = null) => RecordsInner(source, null, options);

        /// <inheritdoc cref="RecordsInner(global::System.IO.Stream, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Inner> Records(global::System.IO.Stream stream, global::CStructSharp.ReadOptions? options = null) => RecordsInner(stream, null, options);

        /// <inheritdoc cref="RecordsInnerAsync(global::System.IO.Stream, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions, global::System.Threading.CancellationToken)"/>
        public static global::System.Collections.Generic.IAsyncEnumerable<Inner> RecordsAsync(global::System.IO.Stream stream, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default) => RecordsInnerAsync(stream, null, options, cancellationToken);

        /// <summary>The record reader of <c>inner</c> without variables, shared by every enumeration that has none.</summary>
        private static readonly global::CStructSharp.Generated.RecordReader<Inner> InnerRecordsWithoutVariables = (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadInnerRecord(source, offset, index, shift, options, null, out consumed);

        /// <summary>The record reader of <c>inner</c> for <paramref name="variables"/>.</summary>
        private static global::CStructSharp.Generated.RecordReader<Inner> InnerRecordReader(global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables)
            => variables is null ? InnerRecordsWithoutVariables : (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadInnerRecord(source, offset, index, shift, options, variables, out consumed);
        ...
        private static Inner ReadInnerRecord(global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, out int consumed)
        {
            var cursor = new global::CStructSharp.Generated.ReadCursor(source.Span.Slice(offset), options, "inner");
            try
            {
                Inner value = ReadInner(ref cursor, variables, null, null);
        ...
        /// <summary>Reads the root declaration (<c>inner</c>) with the runtime layout and maps it to <typeparamref name="T"/> (a <c>[CStructMapped]</c> class, a <see cref="global::CStructSharp.Values.StructValue"/>, ...) with the conversions of <c>Get&lt;T&gt;</c>: <c>Layout.ReadValue&lt;T&gt;(source, RootName, ...)</c>.</summary>
        ...
        /// <summary>Reads the root declaration (<c>inner</c>) with the runtime layout and maps it to <typeparamref name="T"/> (a <c>[CStructMapped]</c> class, a <see cref="global::CStructSharp.Values.StructValue"/>, ...) with the conversions of <c>Get&lt;T&gt;</c>: <c>Layout.ReadValue&lt;T&gt;(stream, RootName, ...)</c>.</summary>
        /// <typeparam name="T">The requested type.</typeparam>
        /// <param name="stream">The input.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        ...
        public readonly ref struct InnerView
        {
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>inner</c> of 1 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            ...
            public static InnerViewEnumerable Enumerate(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null) => new InnerViewEnumerable(source, options);
        }

        /// <summary>The records <see cref="InnerView.Enumerate"/> walks: a <c>foreach</c> source whose enumerator yields one <see cref="InnerView"/> per <c>inner</c>, allocating nothing.</summary>
        public readonly ref struct InnerViewEnumerable
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            ...
            public InnerViewEnumerable(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
            }
            ...
            public InnerViewEnumerator GetEnumerator() => new InnerViewEnumerator(this.source, this.options);
        }

        /// <summary>Walks consecutive <c>inner</c> records of 1 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct InnerViewEnumerator
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            private int offset;
            ...
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <c>ToObject</c> uses.</param>
            public InnerViewEnumerator(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
                this.offset = 0;
            ...
            public readonly InnerView Current => new InnerView(this.source.Slice(this.offset), this.options);
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 1, "inner", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
