...
namespace Demo
{
    ...
    public static partial class FixtureTypedefs
    {
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureTypedefs.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureTypedefs.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureTypedefs.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureTypedefs.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureTypedefs.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary>Stores <c>value</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Value(global::System.Span<byte> target, ushort value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.value");
                try
                {
                    cursor.Position = 0;
                    global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "value", "uint16"), value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint16 value</c> at offset 0.</summary>
            public ushort Value => global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(0, 2), true);
