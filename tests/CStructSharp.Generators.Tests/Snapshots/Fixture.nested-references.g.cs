...
namespace Demo
{
    ...
    public static partial class FixtureNestedReferences
    {
        ...
        /// <summary>Reads one <c>h</c> from a sequence of segments: a single segment is read in place, several are copied into a pooled buffer bounded by the total read budget.</summary>
        /// <param name="source">The bytes; offset 0 is coordinate zero.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The parsed value.</returns>
        public static H ParseH(global::System.Buffers.ReadOnlySequence<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            if (source.IsSingleSegment)
            {
                return ParseH(source.FirstSpan, variables, options);
            }
            byte[] buffer = global::CStructSharp.Generated.ReadCursor.CopySequence(source, options, out int length);
            try
            {
                return ParseH(new global::System.ReadOnlySpan<byte>(buffer, 0, length), variables, options);
            }
            finally
            {
        ...
        /// <summary>Reads one <c>h</c> from <paramref name="stream"/>: the stream is buffered up to the total read budget (or its remaining length) and read through the span reader; a seekable stream is left after the value.</summary>
        /// <param name="stream">The stream, read from its current position.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The parsed value.</returns>
        public static H ParseH(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            ...
            try
            {
                ...
                try
                {
                    return ParseHBuffered(buffer, length, stream, start, variables, options);
                }
                finally
                {
                    global::System.Buffers.ArrayPool<byte>.Shared.Return(buffer);
        ...
        /// <returns>The parsed value.</returns>
        public static async global::System.Threading.Tasks.ValueTask<H> ParseHAsync(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            ...
            using (linked)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        return ParseHBuffered(buffer, length, stream, start, variables, effective);
                    }
                    finally
                    {
                        global::System.Buffers.ArrayPool<byte>.Shared.Return(buffer);
        ...
        private static H ParseHBuffered(byte[] buffer, int length, global::System.IO.Stream stream, long start, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, global::CStructSharp.ReadOptions? options)
        {
            var cursor = new global::CStructSharp.Generated.ReadCursor(new global::System.ReadOnlySpan<byte>(buffer, 0, length), options, "h");
            try
            {
                H value = ReadH(ref cursor, variables, null, null);
                if (stream.CanSeek)
                {
        ...
        /// <summary>Reads one <c>h</c> from the bytes without throwing for a read, path, or limit failure: <see langword="false"/> and the failure instead. Cancellation and argument errors throw as in <see cref="ParseH(global::System.ReadOnlySpan{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        ...
        public static bool TryParseH(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, out global::CStructSharp.Diagnostics.CStructException? failure, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            try
            {
                value = ParseH(source, variables, options);
                failure = null;
                return true;
            }
            catch (global::CStructSharp.Diagnostics.CStructException exception)
        ...
        /// <inheritdoc cref="TryParseH(global::System.ReadOnlySpan{byte}, out H, out global::CStructSharp.Diagnostics.CStructException?, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static bool TryParseH(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null) => TryParseH(source, out value, out _, variables, options);

        /// <summary>Reads one <c>h</c> from the array without throwing for a read, path, or limit failure: <see langword="false"/> and the failure instead. Cancellation and argument errors throw as in <see cref="ParseH(byte[], global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The input.</param>
        /// <param name="value">The parsed value, or <see langword="null"/> when the read failed.</param>
        /// <param name="failure">The failure the throwing form would have raised, or <see langword="null"/>.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>Whether the read succeeded.</returns>
        public static bool TryParseH(byte[] source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, out global::CStructSharp.Diagnostics.CStructException? failure, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            try
            {
                value = ParseH(source, variables, options);
        ...
        /// <inheritdoc cref="TryParseH(byte[], out H, out global::CStructSharp.Diagnostics.CStructException?, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static bool TryParseH(byte[] source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null) => TryParseH(source, out value, out _, variables, options);

        /// <summary>Reads one <c>h</c> from the memory without throwing for a read, path, or limit failure: <see langword="false"/> and the failure instead. Cancellation and argument errors throw as in <see cref="ParseH(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The input.</param>
        /// <param name="value">The parsed value, or <see langword="null"/> when the read failed.</param>
        /// <param name="failure">The failure the throwing form would have raised, or <see langword="null"/>.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>Whether the read succeeded.</returns>
        public static bool TryParseH(global::System.ReadOnlyMemory<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, out global::CStructSharp.Diagnostics.CStructException? failure, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            try
            {
                value = ParseH(source, variables, options);
        ...
        /// <inheritdoc cref="TryParseH(global::System.ReadOnlyMemory{byte}, out H, out global::CStructSharp.Diagnostics.CStructException?, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static bool TryParseH(global::System.ReadOnlyMemory<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null) => TryParseH(source, out value, out _, variables, options);

        /// <summary>Reads one <c>h</c> from the sequence without throwing for a read, path, or limit failure: <see langword="false"/> and the failure instead. Cancellation and argument errors throw as in <see cref="ParseH(global::System.Buffers.ReadOnlySequence{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The input.</param>
        /// <param name="value">The parsed value, or <see langword="null"/> when the read failed.</param>
        /// <param name="failure">The failure the throwing form would have raised, or <see langword="null"/>.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>Whether the read succeeded.</returns>
        public static bool TryParseH(global::System.Buffers.ReadOnlySequence<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, out global::CStructSharp.Diagnostics.CStructException? failure, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            try
            {
                value = ParseH(source, variables, options);
        ...
        /// <inheritdoc cref="TryParseH(global::System.Buffers.ReadOnlySequence{byte}, out H, out global::CStructSharp.Diagnostics.CStructException?, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static bool TryParseH(global::System.Buffers.ReadOnlySequence<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null) => TryParseH(source, out value, out _, variables, options);

        /// <summary>Reads one <c>h</c> from the stream (left at its origin after a failure) without throwing for a read, path, or limit failure: <see langword="false"/> and the failure instead. Cancellation and argument errors throw as in <see cref="ParseH(global::System.IO.Stream, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        ...
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>Whether the read succeeded.</returns>
        public static bool TryParseH(global::System.IO.Stream stream, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, out global::CStructSharp.Diagnostics.CStructException? failure, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            try
            {
                value = ParseH(stream, variables, options);
                failure = null;
                return true;
            }
            catch (global::CStructSharp.Diagnostics.CStructException exception)
        ...
        /// <inheritdoc cref="TryParseH(global::System.IO.Stream, out H, out global::CStructSharp.Diagnostics.CStructException?, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static bool TryParseH(global::System.IO.Stream stream, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null) => TryParseH(stream, out value, out _, variables, options);

        /// <summary>Reads the records of <paramref name="source"/> - one <c>h</c> after another until the memory ends - on the enumeration step that reaches each; each record is 2 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].h</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        public static global::System.Collections.Generic.IEnumerable<H> RecordsH(global::System.ReadOnlyMemory<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromMemory(source, Sizes.H, "h", options, HRecordReader(variables));

        /// <summary>Reads the records of a sequence of segments (one segment in place, several through one pooled copy that lives as long as the enumeration); see <see cref="RecordsH(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The bytes of the records, with nothing else after them.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<H> RecordsH(global::System.Buffers.ReadOnlySequence<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromSequence(source, Sizes.H, "h", options, HRecordReader(variables));

        /// <summary>Reads the records of a stream from its current position: exactly one record at a time, byte-exact, from any readable stream; a seekable stream sits at the record's end after each step. See <see cref="RecordsH(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="stream">The stream, read from its current position.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<H> RecordsH(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead)
            {
        ...
        public static global::System.Collections.Generic.IAsyncEnumerable<H> RecordsHAsync(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return global::CStructSharp.Generated.RecordSequence.FromStreamAsync(stream, Sizes.H, "h", options, HRecordReader(variables), cancellationToken);
        }

        /// <summary>The record reader of <c>h</c> without variables, shared by every enumeration that has none.</summary>
        private static readonly global::CStructSharp.Generated.RecordReader<H> HRecordsWithoutVariables = (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadHRecord(source, offset, index, shift, options, null, out consumed);

        /// <summary>The record reader of <c>h</c> for <paramref name="variables"/>.</summary>
        private static global::CStructSharp.Generated.RecordReader<H> HRecordReader(global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables)
            => variables is null ? HRecordsWithoutVariables : (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadHRecord(source, offset, index, shift, options, variables, out consumed);
        ...
        private static H ReadHRecord(global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, out int consumed)
        {
            var cursor = new global::CStructSharp.Generated.ReadCursor(source.Span.Slice(offset), options, "h");
            try
            {
                H value = ReadH(ref cursor, variables, null, null);
        ...
        /// <summary>Writes one <c>h</c> into a new array with the generated writer; the same bytes, and the same failures, as the runtime's <c>Serialize</c>.</summary>
        ...
        public static byte[] SerializeH(H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            ...
            try
            {
                EncodeH(ref cursor, value, variables, null, null);
        ...
        /// <summary>Writes one <c>h</c> into <paramref name="destination"/>; a value that does not fit fails with the runtime's capacity message.</summary>
        /// <param name="value">The value to write.</param>
        /// <param name="destination">The bytes to write into.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The number of bytes written.</returns>
        public static int SerializeH(H value, global::System.Span<byte> destination, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            var cursor = new global::CStructSharp.Generated.WriteCursor(destination, options, "h");
            try
            {
                EncodeH(ref cursor, value, variables, null, null);
        ...
        /// <summary>Writes one <c>h</c> to <paramref name="stream"/> at its current position.</summary>
        /// <param name="stream">The destination stream.</param>
        /// <param name="value">The value to write.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        public static void WriteH(global::System.IO.Stream stream, H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanWrite)
            {
            ...
            byte[] bytes = SerializeH(value, variables, options);
            stream.Write(bytes, 0, bytes.Length);
        }

        /// <summary>Writes one <c>h</c> to <paramref name="stream"/> with <see cref="global::System.IO.Stream.WriteAsync(global::System.ReadOnlyMemory{byte}, global::System.Threading.CancellationToken)"/>: the value is serialized first (a validation failure writes nothing), then sent in one write.</summary>
        ...
        public static async global::System.Threading.Tasks.ValueTask WriteHAsync(global::System.IO.Stream stream, H value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanWrite)
            {
            ...
            using (linked)
            {
                byte[] bytes = SerializeH(value, variables, effective);
        ...
        /// <summary>Writes one <c>h</c> at the cursor's position.</summary>
        private static void EncodeH(ref global::CStructSharp.Generated.WriteCursor cursor, H? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            if (value is null)
            {
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // h hdr
            {
                ...
                EncodeH(ref cursor, value.Hdr, variables, "hdr", "h");
                placement.CompleteField(cursor.Position);
            }
            // uint8 v[...]
            {
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureNestedReferences.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureNestedReferences.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureNestedReferences.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureNestedReferences.TryParse(source, out value, out failure, options);
        ...
        {
            /// <summary>The members of <c>Hdr</c>.</summary>
            public static class Hdr
            {
                /// <summary><c>offsetof(root, hdr.n)</c>.</summary>
                public const int N = 0;

                /// <summary><c>offsetof(root, hdr.pad)</c>.</summary>
        ...
        public static class Update
        {
            ...
            public static class Hdr
            {
                /// <summary>Stores <c>hdr.n</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void N(global::System.Span<byte> target, byte value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.hdr.n");
                    try
                    {
                        cursor.Position = 0;
                ...
                /// <summary>Stores <c>hdr.pad</c> into <paramref name="target"/> at offset 1, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void Pad(global::System.Span<byte> target, byte value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.hdr.pad");
                    try
                    {
                        cursor.Position = 1;
                        cursor.Reserve(1, "pad", "uint8")[0] = value;
                    }
                    catch (global::CStructSharp.Diagnostics.CStructException exception)
                    {
                        cursor.Complete(exception);
        ...
        /// <summary>
        ///     A zero-allocation view of one <c>h</c> over its bytes: each statically placed member decodes
        ...
        /// </summary>
        public readonly ref struct HView
        {
            ...
            public HView(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null)
            {
                if (source.Length < 2)
                {
                    var cursor = new global::CStructSharp.Generated.ReadCursor(source, options, "h");
            ...
            /// <summary><c>uint8 pad</c> at offset 1.</summary>
            public byte Pad => this.source.Slice(1, 1)[0];

            /// <summary>Reads the whole value with the generated reader (every member, runtime-sized ones included).</summary>
            /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
            /// <returns>The value.</returns>
            public H ToObject(global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null)
            {
                var cursor = new global::CStructSharp.Generated.ReadCursor(this.source, this.options, "h");
                try
                {
                    return ReadH(ref cursor, variables, null, null);
                }
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>h</c> of 2 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            ...
            public static HViewEnumerable Enumerate(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null) => new HViewEnumerable(source, options);
        }

        /// <summary>The records <see cref="HView.Enumerate"/> walks: a <c>foreach</c> source whose enumerator yields one <see cref="HView"/> per <c>h</c>, allocating nothing.</summary>
        public readonly ref struct HViewEnumerable
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            ...
            public HViewEnumerable(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
            }
            ...
            public HViewEnumerator GetEnumerator() => new HViewEnumerator(this.source, this.options);
        }

        /// <summary>Walks consecutive <c>h</c> records of 2 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct HViewEnumerator
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            private int offset;
            ...
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <c>ToObject</c> uses.</param>
            public HViewEnumerator(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
                this.offset = 0;
            ...
            public readonly HView Current => new HView(this.source.Slice(this.offset), this.options);
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 2, "h", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>A view of <c>h hdr</c> at offset 0.</summary>
            public HView Hdr => new(this.source.Slice(0), this.options);
