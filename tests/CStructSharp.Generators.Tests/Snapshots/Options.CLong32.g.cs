...
namespace Demo
{
    ...
    public static partial class Options
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 9 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        public static class Update
        {
            ...
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void A(global::System.Span<byte> target, int value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.a");
                try
                {
                    cursor.Position = 0;
                    global::CStructSharp.Generated.Codec.WriteInt32(cursor.Reserve(4, "a", "int32"), value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>b_c</c> into <paramref name="target"/> at offset 4, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void BC(global::System.Span<byte> target, byte value)
            {
                ...
                try
                {
                    cursor.WriteBits(new global::CStructSharp.Generated.BitfieldSlot(4, 1, 0), 3, value, true, HighBitFirst, "b_c", "uint8");
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>d</c> into <paramref name="target"/> at offset 4, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void D(global::System.Span<byte> target, byte value)
            {
                ...
                try
                {
                    cursor.WriteBits(new global::CStructSharp.Generated.BitfieldSlot(4, 1, 3), 5, value, true, HighBitFirst, "d", "uint8");
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>e</c> into <paramref name="target"/> at offset 5, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>Creates a view over <paramref name="source"/>, whose first byte is the value's first byte; the source must hold the value's 9 bytes.</summary>
            ...
            public RootView(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null)
            {
                ...
                {
                    var cursor = new global::CStructSharp.Generated.ReadCursor(source, options, "root");
                    global::CStructSharp.Diagnostics.CStructException failure = cursor.Fail(global::CStructSharp.Generated.ReadCursor.ShortReadText(9, source.Length), null, null);
            ...
            /// <summary>Gets the value's bytes (its 9 bytes).</summary>
            public global::System.ReadOnlySpan<byte> Bytes => this.source.Slice(0, 9);

            /// <summary><c>int32 a</c> at offset 0.</summary>
            public int A => global::CStructSharp.Generated.Codec.ReadInt32(this.source.Slice(0, 4), true);

            /// <summary><c>uint8 b_c : 3</c> at offset 4.</summary>
            public byte BC => (byte)global::CStructSharp.Generated.Codec.ExtractBits(global::CStructSharp.Generated.Codec.ReadUnsigned(this.source.Slice(4, 1), true), global::CStructSharp.Generated.Codec.BitfieldShift(0, 3, 8, HighBitFirst), 3);

            /// <summary><c>uint8 d : 5</c> at offset 4.</summary>
            public byte D => (byte)global::CStructSharp.Generated.Codec.ExtractBits(global::CStructSharp.Generated.Codec.ReadUnsigned(this.source.Slice(4, 1), true), global::CStructSharp.Generated.Codec.BitfieldShift(3, 5, 8, HighBitFirst), 5);

            /// <summary><c>uint32 e</c> at offset 5.</summary>
            public uint E => global::CStructSharp.Generated.Codec.ReadUInt32(this.source.Slice(5, 4), true);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 9 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 9 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            {
                int next = this.index < 0 ? 0 : this.offset + 9;
                if (next >= this.source.Length)
                {
                    return false;
                }
                if (this.source.Length - next < 9)
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 9, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
