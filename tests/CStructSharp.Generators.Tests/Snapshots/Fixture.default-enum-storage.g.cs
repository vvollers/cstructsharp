...
namespace Demo
{
    ...
    public static partial class FixtureDefaultEnumStorage
    {
        ...
        public sealed partial class Root : global::CStructSharp.ICStructGenerated<Root>
        {
            ...
            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureDefaultEnumStorage.TryParse(source, out value, out failure, options);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>kind type</c> at offset 0.</summary>
            public Kind Type => (Kind)this.source.Slice(0, 1)[0];

            /// <summary><c>uint8 tail</c> at offset 1.</summary>
