// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureTypedefForms. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureTypedefForms
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "typedef struct _X { uint8 a; uint16 b; } X, *PX; typedef uint8 pair[2]; struct root { X x; _X y; pair p; };";
        ...
        public sealed partial class Root
        {
            ...
            /// <summary><c>_X y</c>.</summary>
            public X Y { get; set; } = new();

            /// <summary><c>uint8 p[2]</c>.</summary>
            public byte[] P { get; set; } = global::System.Array.Empty<byte>();
        }
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>X</c> after another until the memory ends - on the enumeration step that reaches each; each record is 3 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].X</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 8 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        /// <param name="source">The bytes of the records, with nothing else after them.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        ...
        private static Root ReadRoot(ref global::CStructSharp.Generated.ReadCursor cursor, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // uint8 p[2]
            {
                ...
                if (count > 0)
                {
                    global::System.ReadOnlySpan<byte> bytes = cursor.TakeArray(count, 1, "p", "uint8");
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // _X y
            {
                ...
                EncodeX(ref cursor, value.Y, variables, "y", "_X");
                placement.CompleteField(cursor.Position);
            }
            // uint8 p[2]
            {
                ...
                if (count > 0)
                {
                    global::System.Span<byte> bytes = cursor.Reserve(count * 1, "p", "uint8");
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureTypedefForms.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureTypedefForms.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureTypedefForms.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureTypedefForms.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureTypedefForms.Serialize(value, destination, options);
        }
        ...
        public static class Offsets
        {
            ...
            public static class X
            {
                ...
                /// <summary><c>offsetof(root, x.b)</c>.</summary>
                public const int B = 1;
            }

            /// <summary>The members of <c>Y</c>.</summary>
            public static class Y
            {
                /// <summary><c>offsetof(root, y.a)</c>.</summary>
                public const int A = 3;

                /// <summary><c>offsetof(root, y.b)</c>.</summary>
        ...
        {
            /// <summary>Stores <c>p</c>[<paramref name="index"/>] into <paramref name="target"/> at offset 6 plus the element's, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="index">The element index.</param>
            /// <param name="value">The new value.</param>
            public static void P(global::System.Span<byte> target, int index, byte value)
            {
                if ((uint)index >= 2u)
                {
                ...
                try
                {
                    cursor.Position = 6 + index * 1;
                    cursor.Reserve(1, "p", "uint8")[0] = value;
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            public static class X
            {
                ...
                /// <summary>Stores <c>x.b</c> into <paramref name="target"/> at offset 1, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void B(global::System.Span<byte> target, ushort value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.x.b");
                    try
                    {
                        cursor.Position = 1;
                        global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "b", "uint16"), value, true);
                    }
                    catch (global::CStructSharp.Diagnostics.CStructException exception)
                    {
                        cursor.Complete(exception);
            ...
            public static class Y
            {
                /// <summary>Stores <c>y.a</c> into <paramref name="target"/> at offset 3, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void A(global::System.Span<byte> target, byte value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.y.a");
                    try
                    {
                        cursor.Position = 3;
                        cursor.Reserve(1, "a", "uint8")[0] = value;
                ...
                /// <summary>Stores <c>y.b</c> into <paramref name="target"/> at offset 4, leaving every other byte alone.</summary>
                /// <param name="target">The bytes holding the value.</param>
                /// <param name="value">The new value.</param>
                public static void B(global::System.Span<byte> target, ushort value)
                {
                    var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.y.b");
                    try
                    {
                        cursor.Position = 4;
                        global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "b", "uint16"), value, true);
        ...
        public readonly ref struct XView
        {
            ...
            /// <summary><c>uint16 b</c> at offset 1.</summary>
            public ushort B => global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(1, 2), true);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>X</c> of 3 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
        ...
        /// <summary>Walks consecutive <c>X</c> records of 3 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct XViewEnumerator
        {
            ...
            {
                int next = this.index < 0 ? 0 : this.offset + 3;
                if (next >= this.source.Length)
                {
                    return false;
                }
                if (this.source.Length - next < 3)
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 3, "X", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>A view of <c>_X y</c> at offset 3.</summary>
            public XView Y => new(this.source.Slice(3), this.options);

            /// <summary>The bytes of <c>uint8 p[2]</c> at offset 6.</summary>
            public global::System.ReadOnlySpan<byte> PBytes => this.source.Slice(6, 2);

            /// <summary>One element of <c>uint8 p[2]</c>.</summary>
            /// <param name="index">The element index.</param>
            /// <returns>The element.</returns>
            public byte P(int index)
            {
                if ((uint)index >= 2u)
                {
                    throw new global::System.ArgumentOutOfRangeException(nameof(index));
                }
                return this.source.Slice(6 + index * 1, 1)[0];
            }
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 8 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <see cref="ToObject"/> uses; <see langword="null"/> uses the documented defaults.</param>
            /// <returns>The enumeration.</returns>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 8 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            public bool MoveNext()
            {
                int next = this.index < 0 ? 0 : this.offset + 8;
                if (next >= this.source.Length)
                {
                    return false;
                }
                if (this.source.Length - next < 8)
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 8, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
