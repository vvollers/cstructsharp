// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureCharacterBuffers. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureCharacterBuffers
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "struct root { char value[2]; byte tail; };";
        ...
        {
            /// <summary><c>char value[2]</c>.</summary>
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // char value[2]
            {
                ...
                count = 2;
                cursor.RequireArrayLength(count, "value", "char");
                cursor.WriteFixedText(count, value.Value, false, true, "value", "char");
                placement.CompleteField(cursor.Position);
            }
            // byte tail
            {
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureCharacterBuffers.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureCharacterBuffers.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureCharacterBuffers.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureCharacterBuffers.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureCharacterBuffers.Serialize(value, destination, options);
        }
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>The bytes of <c>char value[2]</c> at offset 0.</summary>
            public global::System.ReadOnlySpan<byte> ValueBytes => this.source.Slice(0, 2);

            /// <summary><c>char value[2]</c> as text (trailing NULs kept unless the options set <c>TrimFixedText</c>, as the reader does); allocates the string.</summary>
            public string Value => global::CStructSharp.Generated.Codec.DecodeFixedText(ValueBytes, global::CStructSharp.Generated.Codec.TrimsFixedText(this.options));
