...
namespace Demo
{
    ...
    public static partial class HeaderLayout
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>header</c> after another until the memory ends - on the enumeration step that reaches each; each record is 8 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].header</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        public static global::System.Collections.Generic.IEnumerable<Header> RecordsHeader(global::System.ReadOnlyMemory<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromMemory(source, Sizes.Header, "header", options, HeaderRecordReader(variables));

        /// <summary>Reads the records of a sequence of segments (one segment in place, several through one pooled copy that lives as long as the enumeration); see <see cref="RecordsHeader(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="source">The bytes of the records, with nothing else after them.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<Header> RecordsHeader(global::System.Buffers.ReadOnlySequence<byte> source, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
            => global::CStructSharp.Generated.RecordSequence.FromSequence(source, Sizes.Header, "header", options, HeaderRecordReader(variables));

        /// <summary>Reads the records of a stream from its current position: exactly one record at a time, byte-exact, from any readable stream; a seekable stream sits at the record's end after each step. See <see cref="RecordsHeader(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>.</summary>
        /// <param name="stream">The stream, read from its current position.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options each record is read with; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IEnumerable<Header> RecordsHeader(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead)
            {
        ...
        /// <returns>The records, read as they are enumerated.</returns>
        public static global::System.Collections.Generic.IAsyncEnumerable<Header> RecordsHeaderAsync(global::System.IO.Stream stream, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead)
            {
            ...
            return global::CStructSharp.Generated.RecordSequence.FromStreamAsync(stream, Sizes.Header, "header", options, HeaderRecordReader(variables), cancellationToken);
        }

        /// <inheritdoc cref="RecordsHeader(global::System.ReadOnlyMemory{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Header> Records(global::System.ReadOnlyMemory<byte> source, global::CStructSharp.ReadOptions? options = null) => RecordsHeader(source, null, options);

        /// <inheritdoc cref="RecordsHeader(global::System.Buffers.ReadOnlySequence{byte}, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Header> Records(global::System.Buffers.ReadOnlySequence<byte> source, global::CStructSharp.ReadOptions? options = null) => RecordsHeader(source, null, options);

        /// <inheritdoc cref="RecordsHeader(global::System.IO.Stream, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions)"/>
        public static global::System.Collections.Generic.IEnumerable<Header> Records(global::System.IO.Stream stream, global::CStructSharp.ReadOptions? options = null) => RecordsHeader(stream, null, options);

        /// <inheritdoc cref="RecordsHeaderAsync(global::System.IO.Stream, global::System.Collections.Generic.IReadOnlyDictionary{string, int}, global::CStructSharp.ReadOptions, global::System.Threading.CancellationToken)"/>
        public static global::System.Collections.Generic.IAsyncEnumerable<Header> RecordsAsync(global::System.IO.Stream stream, global::CStructSharp.ReadOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default) => RecordsHeaderAsync(stream, null, options, cancellationToken);

        /// <summary>The record reader of <c>header</c> without variables, shared by every enumeration that has none.</summary>
        private static readonly global::CStructSharp.Generated.RecordReader<Header> HeaderRecordsWithoutVariables = (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadHeaderRecord(source, offset, index, shift, options, null, out consumed);

        /// <summary>The record reader of <c>header</c> for <paramref name="variables"/>.</summary>
        private static global::CStructSharp.Generated.RecordReader<Header> HeaderRecordReader(global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables)
            => variables is null ? HeaderRecordsWithoutVariables : (global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, out int consumed) => ReadHeaderRecord(source, offset, index, shift, options, variables, out consumed);
        ...
        private static Header ReadHeaderRecord(global::System.ReadOnlyMemory<byte> source, int offset, int index, long shift, global::CStructSharp.ReadOptions? options, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, out int consumed)
        {
            var cursor = new global::CStructSharp.Generated.ReadCursor(source.Span.Slice(offset), options, "header");
            try
            {
                Header value = ReadHeader(ref cursor, variables, null, null);
        ...
        /// <summary>Reads the root declaration (<c>header</c>) with the runtime layout and maps it to <typeparamref name="T"/> (a <c>[CStructMapped]</c> class, a <see cref="global::CStructSharp.Values.StructValue"/>, ...) with the conversions of <c>Get&lt;T&gt;</c>: <c>Layout.ReadValue&lt;T&gt;(source, RootName, ...)</c>.</summary>
        ...
        /// <summary>Reads the root declaration (<c>header</c>) with the runtime layout and maps it to <typeparamref name="T"/> (a <c>[CStructMapped]</c> class, a <see cref="global::CStructSharp.Values.StructValue"/>, ...) with the conversions of <c>Get&lt;T&gt;</c>: <c>Layout.ReadValue&lt;T&gt;(stream, RootName, ...)</c>.</summary>
        /// <typeparam name="T">The requested type.</typeparam>
        /// <param name="stream">The input.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The read options; <see langword="null"/> uses the documented defaults.</param>
        ...
        public readonly ref struct HeaderView
        {
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>header</c> of 8 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            ...
            public static HeaderViewEnumerable Enumerate(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null) => new HeaderViewEnumerable(source, options);
        }

        /// <summary>The records <see cref="HeaderView.Enumerate"/> walks: a <c>foreach</c> source whose enumerator yields one <see cref="HeaderView"/> per <c>header</c>, allocating nothing.</summary>
        public readonly ref struct HeaderViewEnumerable
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            ...
            public HeaderViewEnumerable(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
            }
            ...
            public HeaderViewEnumerator GetEnumerator() => new HeaderViewEnumerator(this.source, this.options);
        }

        /// <summary>Walks consecutive <c>header</c> records of 8 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct HeaderViewEnumerator
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            private int offset;
            ...
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <c>ToObject</c> uses.</param>
            public HeaderViewEnumerator(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
                this.offset = 0;
            ...
            public readonly HeaderView Current => new HeaderView(this.source.Slice(this.offset), this.options);
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 8, "header", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
