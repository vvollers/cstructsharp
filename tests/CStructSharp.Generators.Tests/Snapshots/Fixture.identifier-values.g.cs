// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureIdentifierValues. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureIdentifierValues
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "struct root { uuid network; guid windows; };";
        ...
        {
            /// <summary><c>uuid network</c>.</summary>
            public global::System.Guid Network { get; set; }

            /// <summary><c>guid windows</c>.</summary>
            public global::System.Guid Windows { get; set; }
        }
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 32 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureIdentifierValues.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureIdentifierValues.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureIdentifierValues.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureIdentifierValues.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureIdentifierValues.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary><c>offsetof(root, network)</c>.</summary>
            public const int Network = 0;

            /// <summary><c>offsetof(root, windows)</c>.</summary>
            public const int Windows = 16;
        }
        ...
        {
            /// <summary>Stores <c>network</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Network(global::System.Span<byte> target, global::System.Guid value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.network");
                try
                {
                    cursor.Position = 0;
                    global::CStructSharp.Generated.Codec.WriteGuid(cursor.Reserve(16, "network", "uuid"), value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>windows</c> into <paramref name="target"/> at offset 16, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Windows(global::System.Span<byte> target, global::System.Guid value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.windows");
                try
                {
                    cursor.Position = 16;
                    global::CStructSharp.Generated.Codec.WriteGuid(cursor.Reserve(16, "windows", "guid"), value, false);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>Creates a view over <paramref name="source"/>, whose first byte is the value's first byte; the source must hold the value's 32 bytes.</summary>
            ...
            public RootView(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null)
            {
                ...
                {
                    var cursor = new global::CStructSharp.Generated.ReadCursor(source, options, "root");
                    global::CStructSharp.Diagnostics.CStructException failure = cursor.Fail(global::CStructSharp.Generated.ReadCursor.ShortReadText(32, source.Length), null, null);
            ...
            /// <summary>Gets the value's bytes (its 32 bytes).</summary>
            public global::System.ReadOnlySpan<byte> Bytes => this.source.Slice(0, 32);

            /// <summary><c>uuid network</c> at offset 0.</summary>
            public global::System.Guid Network => global::CStructSharp.Generated.Codec.ReadGuid(this.source.Slice(0, 16), true);

            /// <summary><c>guid windows</c> at offset 16.</summary>
            public global::System.Guid Windows => global::CStructSharp.Generated.Codec.ReadGuid(this.source.Slice(16, 16), false);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 32 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 32 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            {
                int next = this.index < 0 ? 0 : this.offset + 32;
                if (next >= this.source.Length)
                {
                    return false;
                }
                if (this.source.Length - next < 32)
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 32, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
