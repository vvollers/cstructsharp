...
namespace Demo
{
    ...
    public static partial class FixtureAlignmentAndEndianOverrides
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 6 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        private static Root ReadRoot(ref global::CStructSharp.Generated.ReadCursor cursor, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // uint16> big
            {
                cursor.Seek(placement.AdvanceToField(2), "big", "uint16>");
                value.Big = global::CStructSharp.Generated.Codec.ReadUInt16(cursor.Take(2, "big", "uint16>"), false);
                placement.CompleteField(cursor.Position);
            }
            // uint16< little
            {
                cursor.Seek(placement.AdvanceToField(2), "little", "uint16<");
                value.Little = global::CStructSharp.Generated.Codec.ReadUInt16(cursor.Take(2, "little", "uint16<"), true);
                placement.CompleteField(cursor.Position);
            }
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            {
                cursor.Seek(placement.AdvanceToField(2), "big", "uint16>");
                global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "big", "uint16>"), value.Big, false);
                placement.CompleteField(cursor.Position);
            }
            // uint16< little
            {
                cursor.Seek(placement.AdvanceToField(2), "little", "uint16<");
                global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "little", "uint16<"), value.Little, true);
                placement.CompleteField(cursor.Position);
            }
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureAlignmentAndEndianOverrides.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureAlignmentAndEndianOverrides.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureAlignmentAndEndianOverrides.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureAlignmentAndEndianOverrides.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureAlignmentAndEndianOverrides.Serialize(value, destination, options);
        }
        ...
        public static class Offsets
        {
            ...
            /// <summary><c>offsetof(root, big)</c>.</summary>
            public const int Big = 2;

            /// <summary><c>offsetof(root, little)</c>.</summary>
        ...
        public static class Update
        {
            ...
            /// <summary>Stores <c>big</c> into <paramref name="target"/> at offset 2, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Big(global::System.Span<byte> target, ushort value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.big");
                try
                {
                    cursor.Position = 2;
                    global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "big", "uint16>"), value, false);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>little</c> into <paramref name="target"/> at offset 4, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Little(global::System.Span<byte> target, ushort value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.little");
                try
                {
                    cursor.Position = 4;
                    global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "little", "uint16<"), value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint16> big</c> at offset 2.</summary>
            public ushort Big => global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(2, 2), false);

            /// <summary><c>uint16< little</c> at offset 4.</summary>
            public ushort Little => global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(4, 2), true);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 6 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 6 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 6, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
