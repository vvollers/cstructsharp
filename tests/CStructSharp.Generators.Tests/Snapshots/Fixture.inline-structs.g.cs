// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureInlineStructs. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureInlineStructs
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "struct root { struct { uint8 value; } item; byte tail; };";
        ...
        {
            /// <summary><c>item item</c>.</summary>
            public RootItem Item { get; set; } = new();

            /// <summary><c>byte tail</c>.</summary>
            public byte Tail { get; set; }
        }

        /// <summary>The layout struct <c>item</c> (declared inline).</summary>
        public sealed partial class RootItem
        {
        ...
        /// <summary>Reads one <c>item</c> at the cursor's position.</summary>
        private static RootItem ReadRootItem(ref global::CStructSharp.Generated.ReadCursor cursor, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
        ...
        /// <summary>Writes one <c>item</c> into a new array with the generated writer; the same bytes, and the same failures, as the runtime's <c>Serialize</c>.</summary>
        /// <param name="value">The value to write.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The serialized bytes.</returns>
        public static byte[] SerializeRootItem(RootItem value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            var cursor = new global::CStructSharp.Generated.WriteCursor(options, "item");
            try
            {
                EncodeRootItem(ref cursor, value, variables, null, null);
                return cursor.ToArray();
            }
            catch (global::CStructSharp.Diagnostics.CStructException exception)
            {
        ...
        /// <summary>Writes one <c>item</c> into <paramref name="destination"/>; a value that does not fit fails with the runtime's capacity message.</summary>
        /// <param name="value">The value to write.</param>
        /// <param name="destination">The bytes to write into.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        /// <returns>The number of bytes written.</returns>
        public static int SerializeRootItem(RootItem value, global::System.Span<byte> destination, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            var cursor = new global::CStructSharp.Generated.WriteCursor(destination, options, "item");
            try
            {
                EncodeRootItem(ref cursor, value, variables, null, null);
                return cursor.Length;
        ...
        /// <summary>Writes one <c>item</c> to <paramref name="stream"/> at its current position.</summary>
        /// <param name="stream">The destination stream.</param>
        /// <param name="value">The value to write.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        public static void WriteRootItem(global::System.IO.Stream stream, RootItem value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanWrite)
            {
            ...
            byte[] bytes = SerializeRootItem(value, variables, options);
            stream.Write(bytes, 0, bytes.Length);
        }

        /// <summary>Writes one <c>item</c> to <paramref name="stream"/> with <see cref="global::System.IO.Stream.WriteAsync(global::System.ReadOnlyMemory{byte}, global::System.Threading.CancellationToken)"/>: the value is serialized first (a validation failure writes nothing), then sent in one write.</summary>
        /// <param name="stream">The writable stream; the current position is the output origin.</param>
        /// <param name="value">The value to write.</param>
        /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
        /// <param name="options">The write options; <see langword="null"/> uses the documented defaults.</param>
        /// <param name="cancellationToken">Ends the write before the bytes are sent or at the next boundary the writer checks; linked with the options' token.</param>
        /// <returns>A task that completes when the bytes have been written.</returns>
        public static async global::System.Threading.Tasks.ValueTask WriteRootItemAsync(global::System.IO.Stream stream, RootItem value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null, global::CStructSharp.WriteOptions? options = null, global::System.Threading.CancellationToken cancellationToken = default)
        {
            global::System.ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanWrite)
            {
            ...
            using (linked)
            {
                byte[] bytes = SerializeRootItem(value, variables, effective);
                await stream.WriteAsync(bytes, effective?.CancellationToken ?? default).ConfigureAwait(false);
            }
        }
        ...
        private static void EncodeRoot(ref global::CStructSharp.Generated.WriteCursor cursor, Root? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            ...
            // item item
            {
                ...
                EncodeRootItem(ref cursor, value.Item, variables, "item", "item");
                placement.CompleteField(cursor.Position);
            }
            // byte tail
            {
        ...
        /// <summary>Writes one <c>item</c> at the cursor's position.</summary>
        private static void EncodeRootItem(ref global::CStructSharp.Generated.WriteCursor cursor, RootItem? value, global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables, string? member, string? memberType)
        {
            if (value is null)
            {
                throw cursor.Fail("Null is not valid for struct or union value: item", member, memberType);
            }
            cursor.EnterComposite(member ?? "item", memberType);
            var placement = global::CStructSharp.Generated.CompositeCursor.Start(cursor.Position, Aligned, Packing, Allocation);
            // uint8 value
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureInlineStructs.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureInlineStructs.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureInlineStructs.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureInlineStructs.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureInlineStructs.Serialize(value, destination, options);
        }
        ...
        public static class Sizes
        {
            ...
            /// <summary><c>sizeof(item)</c>.</summary>
            public const int RootItem = 1;
        }
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary>A view of <c>item item</c> at offset 0.</summary>
            public RootItemView Item => new(this.source.Slice(0), this.options);
        ...
        /// <summary>
        ///     A zero-allocation view of one <c>item</c> over its bytes: each statically placed member decodes
        ///     directly from the span when read; a member the view does not expose (runtime-sized, conditional, or placed after one)
        ///     is reached through <see cref="ToObject"/>. A view cannot leave the method that created it.
        /// </summary>
        public readonly ref struct RootItemView
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            ...
            /// <param name="source">The bytes, from the value's start; more may follow (pointer targets, the rest of the input).</param>
            /// <param name="options">The read options <see cref="ToObject"/> uses; <see langword="null"/> uses the documented defaults.</param>
            public RootItemView(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null)
            {
                if (source.Length < 1)
                {
                    var cursor = new global::CStructSharp.Generated.ReadCursor(source, options, "item");
            ...
            /// <param name="variables">Values for the layout's free identifiers, or <see langword="null"/>.</param>
            /// <returns>The value.</returns>
            public RootItem ToObject(global::System.Collections.Generic.IReadOnlyDictionary<string, int>? variables = null)
            {
                var cursor = new global::CStructSharp.Generated.ReadCursor(this.source, this.options, "item");
                try
                {
                    return ReadRootItem(ref cursor, variables, null, null);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>item</c> of 1 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <see cref="ToObject"/> uses; <see langword="null"/> uses the documented defaults.</param>
            /// <returns>The enumeration.</returns>
            public static RootItemViewEnumerable Enumerate(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options = null) => new RootItemViewEnumerable(source, options);
        }

        /// <summary>The records <see cref="RootItemView.Enumerate"/> walks: a <c>foreach</c> source whose enumerator yields one <see cref="RootItemView"/> per <c>item</c>, allocating nothing.</summary>
        public readonly ref struct RootItemViewEnumerable
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            ...
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <c>ToObject</c> uses.</param>
            public RootItemViewEnumerable(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
            }
            ...
            /// <summary>The enumerator <c>foreach</c> uses.</summary>
            /// <returns>An enumerator before the first record.</returns>
            public RootItemViewEnumerator GetEnumerator() => new RootItemViewEnumerator(this.source, this.options);
        }

        /// <summary>Walks consecutive <c>item</c> records of 1 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootItemViewEnumerator
        {
            private readonly global::System.ReadOnlySpan<byte> source;
            private readonly global::CStructSharp.ReadOptions? options;
            private int offset;
            ...
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
            /// <param name="options">The read options each view's <c>ToObject</c> uses.</param>
            public RootItemViewEnumerator(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options)
            {
                this.source = source;
                this.options = options;
                this.offset = 0;
            ...
            /// <summary>Gets the view of the current record.</summary>
            public readonly RootItemView Current => new RootItemView(this.source.Slice(this.offset), this.options);
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 1, "item", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
