...
namespace Demo
{
    ...
    public static partial class FixtureFlags
    {
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureFlags.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureFlags.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureFlags.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureFlags.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureFlags.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary><c>offsetof(root, mode)</c>.</summary>
        ...
        {
            /// <summary>Stores <c>mode</c> into <paramref name="target"/> at offset 0, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Mode(global::System.Span<byte> target, Access value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.mode");
                try
                {
                    cursor.Position = 0;
                    global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "mode", "access"), (ushort)value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>access mode</c> at offset 0.</summary>
            public Access Mode => (Access)global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(0, 2), true);

            /// <summary><c>uint8 tail</c> at offset 2.</summary>
