...
namespace Demo
{
    ...
    public static partial class FixtureBitfieldAllocation
    {
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 3 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        public sealed partial class Root : global::CStructSharp.ICStructGenerated<Root>
        {
            ...
            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureBitfieldAllocation.TryParse(source, out value, out failure, options);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint16 a : 4</c> at offset 0.</summary>
            public ushort A => (ushort)global::CStructSharp.Generated.Codec.ExtractBits(global::CStructSharp.Generated.Codec.ReadUnsigned(this.source.Slice(0, 2), false), global::CStructSharp.Generated.Codec.BitfieldShift(0, 4, 16, HighBitFirst), 4);

            /// <summary><c>uint16 b : 12</c> at offset 0.</summary>
            public ushort B => (ushort)global::CStructSharp.Generated.Codec.ExtractBits(global::CStructSharp.Generated.Codec.ReadUnsigned(this.source.Slice(0, 2), false), global::CStructSharp.Generated.Codec.BitfieldShift(4, 12, 16, HighBitFirst), 12);

            /// <summary><c>uint8 c : 3</c> at offset 2.</summary>
            public byte C => (byte)global::CStructSharp.Generated.Codec.ExtractBits(global::CStructSharp.Generated.Codec.ReadUnsigned(this.source.Slice(2, 1), false), global::CStructSharp.Generated.Codec.BitfieldShift(0, 3, 8, HighBitFirst), 3);
            ...
            /// <summary>Views over the records of <paramref name="source"/> - one <c>root</c> of 3 bytes after another until the source ends - for <c>foreach</c>, allocating nothing. Trailing bytes shorter than one record fail on the step that meets them; each record is its own region (a stored absolute pointer address counts from the record's first byte).</summary>
            /// <param name="source">The bytes of the records, with nothing else after them.</param>
        ...
        /// <summary>Walks consecutive <c>root</c> records of 3 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 3, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
