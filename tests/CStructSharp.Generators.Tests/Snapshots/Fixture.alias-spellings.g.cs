...
namespace Demo
{
    ...
    public static partial class FixtureAliasSpellings
    {
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureAliasSpellings.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureAliasSpellings.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureAliasSpellings.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureAliasSpellings.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureAliasSpellings.Serialize(value, destination, options);
        }
        ...
        {
            /// <summary><c>offsetof(root, kind)</c>.</summary>
            public const int Kind = 0;

            /// <summary><c>offsetof(root, count)</c>.</summary>
            public const int Count = 1;

            /// <summary><c>offsetof(root, length)</c>.</summary>
        ...
        public static class Update
        {
            ...
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Kind(global::System.Span<byte> target, byte value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.kind");
                try
                {
                    cursor.Position = 0;
                    cursor.Reserve(1, "kind", "uint8")[0] = value;
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>count</c> into <paramref name="target"/> at offset 1, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Count(global::System.Span<byte> target, ushort value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.count");
                try
                {
                    cursor.Position = 1;
                    global::CStructSharp.Generated.Codec.WriteUInt16(cursor.Reserve(2, "count", "uint16"), value, true);
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
            ...
            /// <summary>Stores <c>length</c> into <paramref name="target"/> at offset 3, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Length(global::System.Span<byte> target, uint value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.length");
                try
                {
                    cursor.Position = 3;
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint16 count</c> at offset 1.</summary>
            public ushort Count => global::CStructSharp.Generated.Codec.ReadUInt16(this.source.Slice(1, 2), true);

            /// <summary><c>uint32 length</c> at offset 3.</summary>
            public uint Length => global::CStructSharp.Generated.Codec.ReadUInt32(this.source.Slice(3, 4), true);
