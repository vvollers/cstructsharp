// <auto-generated/>
// Generated by CStructSharp from the [CStructLayout] attribute on FixtureAnonymousPromotedMember. Do not edit.
#nullable enable
...
namespace Demo
{
    ...
    public static partial class FixtureAnonymousPromotedMember
    {
        /// <summary>The layout text the members of this class were generated from.</summary>
        public const string Definition = "struct root { uint8 a; struct { uint8 x; uint8 y; }; uint8 b; };";
        ...
        /// <summary>Reads the records of <paramref name="source"/> - one <c>root</c> after another until the memory ends - on the enumeration step that reaches each; each record is 4 bytes. Trailing bytes shorter than one record fail on the step that meets them; a failure names the record by its index before the path (<c>[3].root</c>). Each record is its own region: the read limits apply per record and a stored absolute pointer address counts from the record's first byte.</summary>
        ...
        {
            /// <inheritdoc/>
            static global::CStructSharp.CStruct global::CStructSharp.ICStructGenerated<Root>.Layout => FixtureAnonymousPromotedMember.Layout;

            /// <inheritdoc/>
            static string global::CStructSharp.ICStructGenerated<Root>.RootName => FixtureAnonymousPromotedMember.RootName;

            /// <inheritdoc/>
            static Root global::CStructSharp.ICStructGenerated<Root>.Parse(global::System.ReadOnlySpan<byte> source, global::CStructSharp.ReadOptions? options) => FixtureAnonymousPromotedMember.Parse(source, options);

            /// <inheritdoc/>
            static bool global::CStructSharp.ICStructGenerated<Root>.TryParse(global::System.ReadOnlySpan<byte> source, [global::System.Diagnostics.CodeAnalysis.MaybeNullWhen(false)] out Root value, out global::CStructSharp.Diagnostics.CStructException? failure, global::CStructSharp.ReadOptions? options) => FixtureAnonymousPromotedMember.TryParse(source, out value, out failure, options);

            /// <inheritdoc/>
            static int global::CStructSharp.ICStructGenerated<Root>.Serialize(Root value, global::System.Span<byte> destination, global::CStructSharp.WriteOptions? options) => FixtureAnonymousPromotedMember.Serialize(value, destination, options);
        }
        ...
        public static class Offsets
        {
            ...
            /// <summary><c>offsetof(root, x)</c>.</summary>
            public const int X = 1;

            /// <summary><c>offsetof(root, y)</c>.</summary>
        ...
        public static class Update
        {
            ...
            /// <summary>Stores <c>x</c> into <paramref name="target"/> at offset 1, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void X(global::System.Span<byte> target, byte value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.x");
                try
                {
                    cursor.Position = 1;
            ...
            /// <summary>Stores <c>y</c> into <paramref name="target"/> at offset 2, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void Y(global::System.Span<byte> target, byte value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.y");
                try
                {
                    cursor.Position = 2;
            ...
            /// <summary>Stores <c>b</c> into <paramref name="target"/> at offset 3, leaving every other byte alone.</summary>
            /// <param name="target">The bytes holding the value.</param>
            /// <param name="value">The new value.</param>
            public static void B(global::System.Span<byte> target, byte value)
            {
                var cursor = global::CStructSharp.Generated.WriteCursor.ForUpdate(target, null, "root.b");
                try
                {
                    cursor.Position = 3;
                    cursor.Reserve(1, "b", "uint8")[0] = value;
                }
                catch (global::CStructSharp.Diagnostics.CStructException exception)
                {
                    cursor.Complete(exception);
        ...
        public readonly ref struct RootView
        {
            ...
            /// <summary><c>uint8 x</c> at offset 1.</summary>
            public byte X => this.source.Slice(1, 1)[0];

            /// <summary><c>uint8 y</c> at offset 2.</summary>
            public byte Y => this.source.Slice(2, 1)[0];

            /// <summary><c>uint8 b</c> at offset 3.</summary>
            public byte B => this.source.Slice(3, 1)[0];
        ...
        /// <summary>Walks consecutive <c>root</c> records of 4 bytes; trailing bytes shorter than one record fail on the step that meets them, with the record's index in the path.</summary>
        public ref struct RootViewEnumerator
        {
            ...
            public bool MoveNext()
            {
                ...
                {
                    throw global::CStructSharp.Generated.RecordSequence.Partial(this.source.Length - next, 4, "root", this.index + 1, next);
                }
                this.offset = next;
                this.index++;
                return true;
