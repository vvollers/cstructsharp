...
const examples = path.join(root, "CStructSharp.Docs/examples");
...
fs.writeFileSync(path.join(root, "CStructSharp.Docs/guides/recipes/index.md"), catalog.join("\n"));
