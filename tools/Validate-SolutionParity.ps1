...
param(
    ...
    [string[]]$WebOnlyProjects = @('CStructSharpWeb\wasm\CStructSharpWeb.Wasm.csproj'),

    [string[]]$DeliberatelyExcludedProjects = @('CStructSharp.PackageConsumer\CStructSharp.PackageConsumer.csproj')
)
